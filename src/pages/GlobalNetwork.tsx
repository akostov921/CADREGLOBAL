...
const GlobalNetwork = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* center the main region and enlarge hero typography */}
      <div className="pt-32 pb-20 flex items-start justify-center">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          {/* Hero Section */}
          <div className="mb-16">
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-playfair font-light mb-6 text-foreground tracking-wide">
              Global Network
            </h1>
            <p className="text-xl md:text-2xl text-foreground/60 font-light tracking-wide max-w-3xl mx-auto">
              Worldwide reach. Local precision.
            </p>
            <div className="h-px w-32 bg-accent mx-auto mt-8"></div>
          </div>
